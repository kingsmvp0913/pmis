...
describe('chenhongjun 明細列解析(純函式)', () => {
  ...
  test('8 月新版欄位左移時，契約、本日與累計數值仍各自歸位', () => {
    const r = parseItemRow(row([[59, '13'], [74, '牆面貼石英磚'], [206, 'M2'],
      [230, '1,700.00'], [302, '263.00'], [331, '17.00'],
      [381, '28,900.00'], [440, '118.000']]));
    expect(r).toMatchObject({
      單位: 'M2', 契約單價: 1700, 契約數量: 263,
      本日完成數量: 17, 本日完成金額: 28900, 累計完成數量: 118,
    });
  });
