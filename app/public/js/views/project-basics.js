...
(function () {
  ...
  async function render(content) {
    ...
    function renderDecision(projectId, data) {
      const inputs = {};
      ...
      resultBox.appendChild(el('div', { class: 'card' }, [
        el('div', { class: 'card-title' }, '逐欄裁決(決標公告 vs 系統主檔)'),
        el('div', { class: 'hint', style: 'margin-top:0' },
          '決標公告是權威基準,採用值預設帶公告值;確認無誤或改寫後再送出。'),
      ...
      resultBox.appendChild(el('div', { class: 'card' }, [
        ...
        el('div', { class: 'form-group' }, [
          el('label', {}, '設計單位'), desI,
          el('div', { class: 'hint' }, '預設帶入系統設定(該工程若已另行指定則以工程為準),可直接覆寫。'),
        ]),
        el('div', { class: 'form-group' }, [
