...
// 只掃系統會寫入的分頁——掃別的只是讓清單變大、比對變慢。
// 「監造內容」是 2026-08-11 才加進來的:SP3 開始把施工日誌的天氣寫進它的 C/D 欄
// (weatherToOperations)。這份清單漏一個分頁,那個分頁就完全沒有保護,
// 承辦人上傳的既有內容會被系統直接蓋掉,而且沒有任何徵兆。
const SHEETS = ['工程基本資料', '契約詳細價目表', '監造報表', '每日施工紀錄', '監造內容'];
